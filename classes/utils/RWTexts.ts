...
import enWordYardJson from "src/data/characters/word/cwordyard_en.json";
import enWordHeadJson from "src/data/characters/word/cwordhead_en.json";
import enWordTaskJson from "src/data/characters/word/cwordtask_en.json";
