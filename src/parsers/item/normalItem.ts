import { ApOnlyItem, MaterialOnlyItem, RawItem } from "src/types/item.model";
...
export class NormalItemParser extends BaseParser<RawItem, ApOnlyItem | MaterialOnlyItem> {
