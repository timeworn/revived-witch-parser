...
import characterConfigJson from "../../data/characters/role/roleconfig.json";
import characterCardConfigJson from "../../data/characters/handbook/ccardroleconfig_handbook.json";
import characterRarityJson from "../../data/characters/role/croleraritycfg.json";
import imagePathJson from "../../data/characters/ui/cimagepath.json";
import characterFramesJson from "../../data/characters/manual/characterframes.json";
import characterVocationConfigJson from "../../data/characters/role/cvocationcfg.json";
import characterElementConfigJson from "../../data/characters/role/celementcfg.json";
import cRaceConfig from "../../data/characters/role/cracecfg.json";
import cItemAttr from "../../data/characters/item/citemattr.json";
import cHeadPhotoFrameConfigJson from "../../data/characters/headphoto/cheadphotoframeconfig.json";
import cHeadPhotoConfigJson from "../../data/characters/headphoto/cheadphotoconfig.json";
import cFavourPresentTypeJson from "../../data/characters/role/cfavourpresenttype.json";
import cEquipItemJson from "../../data/characters/item/cequipitem.json";
import cEquipHandbookJson from "../../data/characters/handbook/cequip_handbook.json";
import cEquipSuitJson from "../../data/characters/equip/cequipsuit.json";
import cItemClassToLoadJson from "../../data/characters/item/citemclasstoload.json";
import cAttrEffectIdNameJson from "../../data/characters/role/cattreffectidname.json";
import cUniqueEquipItemJson from "../../data/characters/item/cuniqueequipitem.json";
import cUniqueEquipConfigJson from "../../data/characters/equip/cuniqueequipcfg.json";
import cFurnitureItemJson from "../../data/characters/item/cfurnitureitem.json";
import cFurnitureGroupJson from "../../data/characters/courtyard/cdormfurnituregroup.json";
import cFurnitureTypeJson from "../../data/characters/courtyard/cdormfurnituretype.json";
import cAudioPlayerCellJson from "../../data/characters/courtyard/caudioplayercell.json";
import cAudioPlayerAlbumJson from "../../data/characters/courtyard/caudioplayeralbum.json";
import cSoundSourceJson from "../../data/characters/sound/csoundsource.json";
import cLightTrainingCourseJson from "../../data/characters/courtyard/clighttrainingcourse.json";
import cLightTrainingRarityJson from "../../data/characters/courtyard/clighttrainingrarity.json";
import cAchieveMissionConfigJson from "../../data/characters/mission/cachievemissionconfig.json";
import cAchieveBadgeGroupJson from "../../data/characters/mission/cachievebadgegroup.json";
import cAchieveBadgeConfigJson from "../../data/characters/mission/cachievebadgeconfig.json";
import cAchieveLevelConfigJson from "../../data/characters/mission/cachievelevelconfig.json";
import cDailyMissionConfigJson from "../../data/characters/mission/cdailymissionconfig.json";
import cDailyMissionAwardJson from "../../data/characters/mission/cdailymissionaward.json";
import cAlchemyFormulaJson from "../../data/characters/courtyard/calchemyformula.json";
import cAlchemyFormulaTypeJson from "../../data/characters/courtyard/calchemyformulatype.json";
import cAlchemyLvJson from "../../data/characters/courtyard/calchemylv.json";
import enCVoiceSourceJson from "../../data/characters/sound/cvoicesource_ja_jp_overseas_en.json";

const RW_ASSETS = "rw/assets/GLOBAL";

const configData: { [key: string]: ICharacterConfig | undefined } = characterConfigJson.Data;
const cardConfigData: { [key: string]: ICharacterHandbook | undefined } = characterCardConfigJson.Data;
const rarityConfigData: { [key: number]: ICharacterRarityConfig | undefined } = characterRarityJson.Data;
const raceConfigData: { [key: number]: ICharacterRaceConfig | undefined } = cRaceConfig.Data;
const vocationConfigData: {
  [key: number]: ICharacterVocationData | undefined;
} = characterVocationConfigJson.Data;
const elementConfigData: { [key: number]: ICharacterElementData | undefined } = characterElementConfigJson.Data;
const imagePathData: { [key: string]: CImagePath | undefined } = imagePathJson.Data;
const characterFrames: { [key: string]: string | undefined } = characterFramesJson;
const itemAttrData: { [key: string]: ItemData } = cItemAttr.Data;
const headPhotoFrameConfigData = cHeadPhotoFrameConfigJson.Data;
const headPhotoConfigData: { [key: string]: IHeadPhotoConfigData | undefined } = cHeadPhotoConfigJson.Data;
...
const equipHandbookData: { [key: string]: ICEquipHandbookData } = cEquipHandbookJson.Data;
const cEquipSuitData: ICEquipSuitData[] = cEquipSuitJson.Data;
const cItemClassToLoadData: { [key: string]: ICItemClassToLoadData } = cItemClassToLoadJson.Data;
const cAttrEffectIdNameData: { [key: string]: ICAttrEffectIdNameData } = cAttrEffectIdNameJson.Data;
const cUniqueEquipItemData: { [key: string]: ICUniqueEquipItemData } = cUniqueEquipItemJson.Data;
const cUniqueEquipConfigData: { [key: string]: ICUniqueEquipConfigData } = cUniqueEquipConfigJson.Data;
const cFurnitureItemData: { [key: string]: ICFurnitureItemData } = cFurnitureItemJson.Data;
const cFurnitureGroupData: { [key: string]: ICFurnitureGroupData } = cFurnitureGroupJson.Data;
...
const cAudioPlayerAlbumData: { [key: string]: ICAudioPlayerAlbumData } = cAudioPlayerAlbumJson.Data;
const cSoundSourceData: { [key: string]: ICSoundSourceData } = cSoundSourceJson.Data;
const cLightTrainingCourseData: ICLightTrainingCourseData[] = cLightTrainingCourseJson.Data;
const cLightTrainingRarityData: ICLightTrainingRarityData[] = cLightTrainingRarityJson.Data;
const cAchieveMissionConfigData: { [key: string]: ICAchieveMissionConfigData } = cAchieveMissionConfigJson.Data;
const cAchieveBadgeGroupData: ICAchieveBadgeGroupData[] = cAchieveBadgeGroupJson.Data;
const cAchieveBadgeConfigData: { [key: string]: ICAchieveBadgeConfigData } = cAchieveBadgeConfigJson.Data;
const cAchieveLevelConfigData: ICAchieveLevelConfigData[] = cAchieveLevelConfigJson.Data;
const cDailyMissionConfigData: { [key: string]: ICDailyMissonConfigData } = cDailyMissionConfigJson.Data;
const cDailyMissionAwardData: { [key: string]: ICDailyMissionAwardData } = cDailyMissionAwardJson.Data;
const cAlchemyFormulaData: { [key: string]: ICAlchemyFormulaData } = cAlchemyFormulaJson.Data;
const cAlchemyFormulaTypeData: ICAlchemyFormulaTypeData[] = cAlchemyFormulaTypeJson.Data;
const cAlchemyLvData: ICAlchemyLvData[] = cAlchemyLvJson.Data;
const enCVoiceSourceData: {
  [key: string]: ICSoundSourceData;
...
export namespace RWUtils {
  ...
  export const getSkillAttributes = (skillId: number, skillShowData: any, changeIndex: number, max?: number) => {
    ...
    while (true) {
      ...
      if (
        skillIdStr.substring(0, changeIndex + 1) !== newSkillIdStr.substring(0, changeIndex + 1) ||
        (max && index > max)
      ) {
  ...
  export const replaceDescriptionParameters = (description: string, skillAttributes: string[][]) => {
    if (!description) return description;

    const usageCounts = new Array(skillAttributes.length).fill(0);

    for (let i = 0; i < skillAttributes.length; i++) {
      const colorRegex = new RegExp(`(<color=#[0-9A-Fa-f]{6}>)?\\$parameter${i + 1}\\$?(</color>)?`, "g");
  ...
  export const createItemAmount = (itemIds: number[] | number, amounts: number[] | number) => {
  ...
  export const createItemWithAmount = (itemAmount: ItemAmount | ItemAmount[]): ItemWithAmount[] => {
    if (Array.isArray(itemAmount)) {
      return itemAmount.map((itemAmount) => ({
        item: new RWItem(getItemAttr(itemAmount.itemId)).toJson(),
  ...
  export const getRarityConfig = (rarity: number) => rarityConfigData[rarity - 1];
  ...
  export const getHeadPhotoFrameConfig = (id: number) => headPhotoFrameConfigData[id - 1];
  ...
  export const getEquipSuit = (id: number): ICEquipSuitData | undefined => cEquipSuitData[id - 1];
  ...
  export const getUniqueEquipConfig = (id: number) =>
    Object.values(cUniqueEquipConfigData).filter((config) => config.UniqueEquipid === id);
  ...
  export const getAudioPlayerCell = (id: number) => cAudioPlayerCellData[id - 1];
  ...
  export const getLightTrainingCourse = (id: number) => cLightTrainingCourseData[id - 1];
  ...
  export const getLightTrainingRarity = (id: number) => cLightTrainingRarityData[id - 1];
  ...
  export const getAchieveMissionConfig = (id: number) => cAchieveMissionConfigData[id];
  ...
  export const getAchieveBadgeGroup = (id: number) => cAchieveBadgeGroupData[id - 1];
  export const getAchieveBadgeGroupData = () => cAchieveBadgeGroupData;
  export const getAchieveBadgeGroupJson = () => cAchieveBadgeGroupJson;

  export const getAchieveBadgeConfig = (id: number) => cAchieveBadgeConfigData[id];
  ...
  export const getAchieveLevelConfig = (id: number) => cAchieveLevelConfigData[id - 1];
  ...
  export const getDailyMissionConfig = (id: number) => cDailyMissionConfigData[id];
  ...
  export const getDailyMissionAward = (id: number) => cDailyMissionAwardData[id];
  ...
  export const getAlchemyFormulaType = (id: number) => cAlchemyFormulaTypeData[id - 1];
