...
import characterVocationJson from "../../../data/characters/manual/charactervocation.json";
import characterElementJson from "../../../data/characters/manual/characterelements.json";
import characterAffiliationJson from "../../../data/characters/handbook/caffiliation_handbook.json";
import { RWUtils } from "../../utils/RWUtils";
import { getImageUrl } from "../../../hooks/getImage";
import { RWTexts } from "../../utils/RWTexts";
import cFavourExpJson from "../../../data/characters/role/cfavourexp.json";
import cFavourPresentJson from "../../../data/characters/role/cfavourpresent.json";
import cFavourGiftTypeJson from "../../../data/characters/role/cfavourgifttype.json";
