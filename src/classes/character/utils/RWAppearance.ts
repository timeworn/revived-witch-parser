...
import cRoleSkinJson from "../../../data/characters/role/croleskin.json";
import cskinJson from "../../../data/characters/role/cskin.json";
import nNpcShapeJson from "../../../data/characters/npc/cnpcshape.json";
